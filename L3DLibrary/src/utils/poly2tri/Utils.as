package utils.poly2tri {
	public class Utils {
		 ...
		 */
		static public function insideIncircle(pa:PPoint, pb:PPoint, pc:PPoint, pd:PPoint):Boolean {
		...
		static public function inScanArea(pa:PPoint, pb:PPoint, pc:PPoint, pd:PPoint):Boolean {
			var pdx:Number = pd.x;
			var pdy:Number = pd.y;
