...
package utils.gif.encoder
{
	...
	public class LZWEncoder
	{
		...
		public function LZWEncoder (width:int, height:int, pixels:ByteArray, color_depth:int)
		{
		...
		private function char_out(c:Number, outs:ByteArray):void
		{
