package utils.bulkloader.lazyloaders{
    import utils.bulkloader.*;
    import utils.bulkloader.loadingtypes.*;
    import utils.bulkloader.lazyloaders.*;
    import flash.events.*;
	import flash.net.*;
        ...
        */
    	lazy_loader override function _lazyParseLoader(withData : String) : void{
    		...
    		for each (var itemNode:XML in xml.files.children()) {
    			...
    			//	print("[LazyBulkLoader] got a item files with no url, ignoring");
    				continue;
    			}
    			//print(String(itemNode.url));
