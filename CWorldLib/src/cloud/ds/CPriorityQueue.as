package cloud.ds
{
	...
	public class CPriorityQueue
	{
		...
		/**
		 * * 最小优先队列
		 * @param compareFunc  返回负数，则a排在b前边,如果不指定，默认为 function (a:Number,b:Number):Number{return a-b}; 
		 * @param keys
		 * 
		 */		
		public function CPriorityQueue(compareFunc:Function = null , keys:Array = null):void
		{
			if(compareFunc == null)
