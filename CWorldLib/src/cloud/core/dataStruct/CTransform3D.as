package cloud.core.dataStruct
{
	...
	public class CTransform3D
	{
		...
		public function append(transform:CTransform3D):void {
			var ta:Number = a;
			var tb:Number = b;
			var tc:Number = c;
			var td:Number = d;
		...
		public function prepend(transform:CTransform3D):void {
			var ta:Number = a;
			var tb:Number = b;
			var tc:Number = c;
			var td:Number = d;
		...
		public function combine(transformA:CTransform3D, transformB:CTransform3D):void {
		...
		public function calculateInversion(source:CTransform3D):void {
		...
		public function copy(source:CTransform3D):void {
			a = source.a;
			b = source.b;
			c = source.c;
			d = source.d;
