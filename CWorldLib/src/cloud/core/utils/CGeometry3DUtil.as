package cloud.core.utils
{
	 ...
	 * @author cloud
	 */
	public class CGeometry3DUtil
	{
		private static var _Instance:CGeometry3DUtil;
		
		public static function get Instance():CGeometry3DUtil
		{
			return _Instance ||= new CGeometry3DUtil(new SingletonEnforce());
		}
		...
		public function CGeometry3DUtil(enforcer:SingletonEnforce)
		{
		}
		 ...
		 * 
		 */		
		public function intersectPlaneByRay(ray:CRay,planePos:CVector,planeNormal:CVector,intersectPos:CVector):Boolean
		{
			var tmpVec:Vector3D;
