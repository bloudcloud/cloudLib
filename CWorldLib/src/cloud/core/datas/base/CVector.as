package cloud.core.datas.base
{
	...
	{
		private static const _TOLERANCE:Number=0.001;
...
//			vec.mode=mode;
		...
		{
			return Math.abs(vecA.x-vecB.x)<_TOLERANCE && Math.abs(vecA.y-vecB.y)<_TOLERANCE && Math.abs(vecA.z-vecB.z)<_TOLERANCE;
		}
		/**
		 * A向量与B向量是否全部相等 
		 * @param vecA	A向量
