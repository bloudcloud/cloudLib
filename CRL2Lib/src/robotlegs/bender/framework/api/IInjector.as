...
package robotlegs.bender.framework.api
{
	 ...
	 */
	[Event(name='mappingOverride', type='swiftsuspenders.mapping.MappingEvent')]
	/**
	 ...
	 */
	[Event(name='postConstruct', type='swiftsuspenders.InjectionEvent')]
	/**
	...
	*/
	[Event(name='postInstantiate', type='swiftsuspenders.InjectionEvent')]
	/**
	 ...
	 */
	[Event(name='postMappingChange', type='swiftsuspenders.mapping.MappingEvent')]
	/**
	 ...
	 */
	[Event(name='postMappingCreate', type='swiftsuspenders.mapping.MappingEvent')]
	/**
	 ...
	 * @eventType org.swiftsuspenders.MappingEvent.POST_MAPPING_REMOVE
	 */
	[Event(name='postMappingRemove', type='swiftsuspenders.mapping.MappingEvent')]
	/**
	 ...
	 */
	[Event(name='preConstruct', type='swiftsuspenders.InjectionEvent')]
	/**
	 ...
	 */
	[Event(name='preMappingChange', type='swiftsuspenders.mapping.MappingEvent')]
	/**
	 * This event is dispatched each time the injector creates a new mapping for a type/ name
	 ...
	 */
	[Event(name='preMappingCreate', type='swiftsuspenders.mapping.MappingEvent')]
	/**
