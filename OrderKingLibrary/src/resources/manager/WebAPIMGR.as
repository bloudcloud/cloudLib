...
//		private static const Domain:String = "http://192.168.1.125:8086/";
		...
		{
			Security.loadPolicyFile("http://www.lejia3d.com/crossdomain.xml");
		...
		private function orderLogin(user:String,password:String):void
		{
			...
			variable.token = "";
//			variable.body = com.adobe.serialization.json.JSON.encode(data);
...
//			var jsonResult:Object = com.adobe.serialization.json.JSON.decode(result);
