/*
　* 名称:as3oop设计模式之龟兔赛跑RunWithStop类实现Irun接口
　* 功能:建立一个RunWithStop(不跑动）类，实现Irun接口
　* 版本:学习版0.1
　* 日期:2010-10-14
　* 作者:coolwind
...
*/
package oop.race{
	public class RunWithStop implements IRun {
		import flash.utils.getQualifiedClassName;
		import flash.utils.getDefinitionByName;
		public function run(an:Animals):void {
			var target=an as Animals;
			target.statusText.text="run with speedStop!";			
			target.sp=0;
