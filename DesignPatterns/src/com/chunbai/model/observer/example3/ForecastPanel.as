package com.chunbai.model.observer.example3
{
	...
	public class ForecastPanel extends MovieClip implements IDisplay,IObserver
	{
		...
		public function ForecastPanel(weatherData:ISubject)
		{
		...
		{
			trace("ForecastPanel 气压：" + _qiYa + "; 温度：" + _wenDu + "; 湿度" + _shiDu);
