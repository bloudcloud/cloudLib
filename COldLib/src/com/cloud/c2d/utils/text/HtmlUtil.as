package  com.cloud.c2d.utils.text
{
	...
	public class HtmlUtil
	{
		...
		public static function getLinkStr(str:String,linkEvt:String,color:uint = 0xffff00):String
		{
			var colorStr:String = "#" + color.toString(16);
			return StringUtils.paramContent("<a href='event:{0}'><font color='{1}'><u>{2}</u></font></a><br />",linkEvt,colorStr,str);
		}
		/** 添加链接 */
		public static function link(str:String,linkEvt:String="myevent",color:uint=0xffff00):String
		{
			...
			return "<a href='event:"+linkEvt+"'><font color='" + colorStr + "'><u>"+str+"</u></font></a>";
		}
